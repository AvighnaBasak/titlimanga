    ...
    >
      <defs>
        <linearGradient id="wingLeft" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#E5197B" />
        ...
        <linearGradient id="wingInner" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#C0166A" />
          <stop offset="100%" stopColor="#E5197B" />
        </linearGradient>
      </defs>
      {/* Left upper wing */}
      <path
      ...
      />
      {/* Body */}
      <ellipse cx="32" cy="34" rx="2" ry="10" fill="#FFB3D9" />
      {/* Antennae */}
      <path
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx="24" cy="15.5" r="1.2" fill="#FF4DA6" />
